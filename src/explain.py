...
# Human-readable names live in src/naming.py, which has no third-party
# imports, so the Streamlit app can use them without pulling in shap.
from src.naming import PRETTY, pretty  # noqa: F401  (re-exported)
